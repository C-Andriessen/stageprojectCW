    ...
    <div class="row justify-content-center">
        ...
        <div class="col-10 col-md-9">
            <div class="d-flex justify-content-between  mb-4 flex-column flex-md-row">
                ...
                <form action="{{ route('admin.projects.tasks.completed.search', $project) }}">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('admin.projects.tasks.open', $project) }}">Open</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('admin.projects.tasks.completed', $project) }}">Afgerond</a>
                        </li>
                    </ul>
