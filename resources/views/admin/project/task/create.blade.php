    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between  mb-4 flex-column flex-md-row">
                <h1 class="mb-4">{{ __('Taak toevoegen') }}</h1>
            ...
            <div class="card mb-5">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.projects.tasks.store', $project) }}">
                        ...
                        <select class="form-select mb-5 select2" name="user" style="padding: 10px">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.projects.tasks.open', $project) }}" class=" btn btn-link text-dark text-decoration-none">Annuleren</a>
