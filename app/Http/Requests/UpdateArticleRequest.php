...
class UpdateArticleRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('editUpdate', request()->article);
    }
    ...
    public function messages()
    {
        return [
            ...
            'title.min' => 'De lengte van een titel moet tenminste :min karakters lang zijn.',
            'title.max' => 'De titel mag niet langer zijn dan :max karakters.',
            'introduction.required' => 'Een introductie is verplicht.',
            'introduction.max' => 'De introductie mag niet langer zijn dan :max karakters.',
            'content.required' => 'Een artikel is verplicht',
            'content.max' => 'Het artikel mag niet langer zijn dan :max karakters.',
